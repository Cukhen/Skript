...
$ y = \boldsymbol{A} \boldsymbol{a}$ nennt man das Fehlergleichungssystem und typischerweise gibt es keine Lösung. \\
Die Gleichungen heißen $0=\frac{\partial E(\{a_m\})}{\partial a_i}$ mit $i=1...m$ Normalengleichungen.
Normalgleichungssystem $A^TAa=A^Ty$
